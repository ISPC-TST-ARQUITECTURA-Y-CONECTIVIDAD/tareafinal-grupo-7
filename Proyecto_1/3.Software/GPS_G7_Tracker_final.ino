...
//Configuraciones basicas: ESP32 MQTT user config
const char* ssid = "..............."; // Wifi SSID
const char* password = ".............."; // Wifi Password
const char* username = "................"; // AskSensors username
const char* pubTopic = "publish/......../.............."; // publish/username/apiKeyIn
const unsigned int writeInterval = 5000; // write interval (in ms) - valor original (25000)

//static const int RXPin = 16, TXPin = 17; // codigo original
...
SoftwareSerial ss(RXPin, TXPin); // La Conexion serial al GPS 
